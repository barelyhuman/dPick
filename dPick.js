...
var dPick = /** @class */ (function () {
    ...
    dPick.prototype.addSelectors = function () {
        ...
        forEach(this.selectors, function (key, value) {
            ...
            var upButton = elemGrab(el, ".dpickr-up");
            var downButton = elemGrab(el, ".dpickr-down");
            _this.selectors[key] = elemGrab(el, ".dpickr-date");
